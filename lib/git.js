...
function deploy(action) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield (0, execute_1.execute)(`rsync -av --checksum --progress ${action.folderPath}/. ${action.targetFolder
            ...
            const hasFilesToCommit = action.isTest & constants_1.TestFlag.HAS_CHANGED_FILES ||
                Boolean((yield (0, execute_1.execute)(checkGitStatus, `${action.workspace}/${temporaryDeploymentDirectory}`, false // This output is always silenced due to the large output it creates.
                )).stdout);
